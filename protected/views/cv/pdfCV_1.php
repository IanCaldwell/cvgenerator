...
<body>
    ...
    <div id="Personal-Details">
        <div style="font-size:30px;border:none;margin-bottom:0px;">Personal Details</div>
        <hr style="height:1px;border:none;color:blue;background-color:#333;" />
        <ul style="list-style-type:none">
            <li>Address: <?php echo "&nbsp;&nbsp;".$this->_user->profile->profile_address_1.", ".$this->_user->profile->profile_address_2.", ".$this->_user->profile->profile_address_3.", ".$this->_user->profile->profile_address_4; ?></li>
    ...
    <div id="Languages">
        <?php if(empty($this->_cv->languages)==false){ ?>
            <div style="font-size:30px;border:none;">Programming Languages</div> 
            <hr style="height:1px;border:none;color:blue;background-color:#333;" />

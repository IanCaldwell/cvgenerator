...
class LanguageController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Language']))
		{
			...
			if($model->save())
                        {
                            $model->refresh();                            
                            $joinModel=new UserJoinLanguage();
                            $joinModel->cvgen_user_id=Yii::app()->user->id;
                            $joinModel->cvgen_language_id=$model->language_id;
	...
	{
            $join= UserJoinLanguage::model()->findByAttributes(array('cvgen_language_id'=>$id,'cvgen_user_id'=>Yii::app()->user->id));
            $join->delete();
            $model=$this->loadModel($id);

...
class AchievementsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Achievements']))
		{
			$model->attributes=$_POST['Achievements'];
                        ...
                        {
                            $model->refresh();                            
                            $joinModel=new UserJoinAchievements;
                            $joinModel->cvgen_user_id=Yii::app()->user->id;
                            $joinModel->cvgen_achievement_id=$model->achievement_id;
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Achievements']))
		{
			$model->attributes=$_POST['Achievements'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->achievement_id));
		}
	...
	{
                $join= UserJoinAchievements::model()->findByAttributes(array('cvgen_achievement_id'=>$id,'cvgen_user_id'=>Yii::app()->user->id));
                $join->delete();
                $model=$this->loadModel($id);
	 ...
	 * @param Achievements $model the model to be validated
	 */

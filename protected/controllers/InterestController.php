...
class InterestController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Interest']))
		{
			...
			if($model->save())
                        {                       
                            $model->refresh();                            
                            $joinModel=new UserJoinInterest;
                            $joinModel->cvgen_user_id=Yii::app()->user->id;
                            $joinModel->cvgen_interest_id=$model->interest_id; 
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Interest']))
		{
			$model->attributes=$_POST['Interest'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->interest_id));
		}
	...
	{
            $join= UserJoinInterest::model()->findByAttributes(array('cvgen_interest_id'=>$id,'cvgen_user_id'=>Yii::app()->user->id));
            $join->delete();
            $model=$this->loadModel($id);
